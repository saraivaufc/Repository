...
#from django.contrib.auth.decorators import login_required, permission_required
#@method_decorator(permission_required, 'manager.admin_publication_list')

class PublicationListView(ListView):
	template_name = 'manager/admin/publication/list.html'
...
class PublicationCreateView(CreateView):
	template_name = 'manager/admin/publication/form.html'
	model = Publication
	...
	success_url = reverse_lazy('manager:admin_publication_list', kwargs={'page': 1})
...
class PublicationDeleteView(DeleteView):
	template_name = 'manager/admin/publication/check_delete.html'
	model = Publication
	success_url = reverse_lazy('manager:admin_publication_list', kwargs={'page': 1})

class PublicationDetailView(DetailView):
	template_name = 'manager/admin/publication/detail.html'
	model = Publication
