...
#from django.contrib.auth.decorators import login_required, permission_required
#@method_decorator(permission_required, 'manager.admin_community_list')


class CommunityListView(ListView):
	template_name = 'manager/admin/community/list.html'
...
class CommunityCreateView(CreateView):
	template_name = 'manager/admin/community/form.html'
	model = Community
	fields = ['name','acronym']
	success_url = reverse_lazy('manager:admin_community_list', kwargs={'page': 1})
...
class CommunityDeleteView(DeleteView):
	template_name = 'manager/admin/community/check_delete.html'
	model = Community
	success_url = reverse_lazy('manager:admin_community_list', kwargs={'page': 1})

class CommunityDetailView(SingleObjectMixin, ListView):
	paginate_by = settings.PAGINATE_BY
	template_name = 'manager/admin/community/detail.html'
	#model = Community
