...
urlpatterns = [
	url(r'^list$', CommunityListView.as_view(), name="community_list"),
	url(r'^add$', permission_required('manager.add_community')(CommunityCreateView.as_view()), name="community_create"),
	url(r'^(?P<slug>[-\w]+)/detail$', CommunityDetailView.as_view(), name="community_detail"),
	...
	url(r'^(?P<slug>[-\w]+)/publications$', CommunityPublicationsView.as_view(), name="community_publications"),
]