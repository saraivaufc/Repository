...
class ParticipantListView(ListView):
	...
	def get_queryset(self):
		...
		if query and query in dict(self.fields_search):
			...
			return User.objects.filter(is_moderator=False, is_staff=False, is_reviser=False, ** kwargs)
		return User.objects.filter(is_moderator=False, is_staff=False, is_reviser=False)
