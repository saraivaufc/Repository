...
urlpatterns = [
	...
	url(_(r'^list_to_review$'), permission_required('submission.list_submission_to_review')(SubmissionsToReviewListView.as_view()), name="submission_list_to_review"),
	...
	url(_(r'^(?P<slug>[-\w]+)/detail_to_review$'), permission_required('submission.detail_submission_to_review')(SubmissionToReviewDetailView.as_view()), name="submission_detail_to_review"),
