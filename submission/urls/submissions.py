...
urlpatterns = [
	url(r'^list$', SubmissionListView.as_view(), name="submission_list"),
	url(r'^list_all$', permission_required('submission.list_submission_to_review')(SubmissionsToReviewListView.as_view()), name="submission_list_to_review"),
	...
	url(r'^submission_final$', permission_required('submission.submit_final')(SubmissionFinal.as_view()), name="submission_final"),
]